        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    time_of_day = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ...
                    transition = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    date_created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    date_last_modified = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_scene_elements_heading_columns", "type = 'Heading' OR (location_id IS NULL AND time_of_day IS NULL)");
                    ...
                    table.CheckConstraint("ck_scene_elements_transition_columns", "type = 'Transition' OR transition IS NULL");
                    table.ForeignKey(
