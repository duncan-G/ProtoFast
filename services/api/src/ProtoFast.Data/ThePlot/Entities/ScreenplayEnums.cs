...
// Stored by name (see ThePlotDbContext), so members can be reordered or added without a data
// migration; renaming one does need one.

/// <summary>What a <see cref="SceneElement"/> is, and so which of its optional columns apply.</summary>
