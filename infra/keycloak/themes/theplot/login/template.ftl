<#--
  The ThePlot lockup, from the design system: Newsreader serif on one
  baseline — "The" italic at 400 against "Plot" at 500 — closed with the
  plot-point, a small square of the brand accent. The same lockup is drawn by
  clients/theplot/src/app/shared/theplot-logo.ts; if one changes, change both.
-->
<#macro pfBrandLockup>
  <span class="pf-brand-word"><em>The</em><b>Plot</b></span><span class="pf-brand-dot" aria-hidden="true"></span></#macro>
...
<head>
  ...
  <#-- Newsreader / Geist / JetBrains Mono carry Ember's three registers; the
       app loads them the same way. Self-host under resources/fonts/ if the
       third-party request on the auth page ever becomes a concern. -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Newsreader:ital,opsz,wght@0,6..72,300..600;1,6..72,300..600&family=Geist:wght@400;500;600&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">
...
<body class="${properties.kcBodyClass!}">
  ...
  <main class="${properties.kcLoginClass!}">
    ...
    <p class="pf-footnote">&copy; ${.now?string('yyyy')} ThePlot. Built fast, obviously.</p>
  </main>
</body>
</html>
</#macro>
