...
# pulls, SSM and CloudWatch go out over IPv6 (dualstack endpoints: the CLI/SDKs
# via AWS_USE_DUALSTACK_ENDPOINT, the SSM agent via its own UseDualStackEndpoint
# config — see user_data).
# Nothing dials in.
#
